...
class HomeTableViewCell: UITableViewCell {
    ...
    private func setupCollectionView() {
        collectionViewHome.register(
            UINib(
                nibName: Main.CellIdentifier.HomeCategoryCollectionViewCell,
                bundle: nil
            ),
        ...
        collectionViewHome.register(
            UINib(
                nibName: Main.CellIdentifier.PopularCollectionViewCell,
                bundle: nil
            ),
            forCellWithReuseIdentifier: Main.CellIdentifier
        ...
        collectionViewHome.register(
            UINib(
                nibName: Main.CellIdentifier.MostPopularCollectionViewCell,
                bundle: nil
            ),
            forCellWithReuseIdentifier: Main.CellIdentifier
        ...
        collectionViewHome.register(
            UINib(
                nibName: Main.CellIdentifier.RecentItemsCollectionViewCell,
                bundle: nil
            ),
            forCellWithReuseIdentifier: Main.CellIdentifier
    ...
    func updateCollectionHeight() {
        if let layout = collectionViewHome.collectionViewLayout
            as? UICollectionViewFlowLayout,
            layout.scrollDirection == .vertical
        {
            self.collectionViewHomeHeight.constant =
                self.collectionViewHome.collectionViewLayout
    ...
    UICollectionViewDelegate, UICollectionViewDelegateFlowLayout
{
        ...
        case .category:
            let cell =
                collectionView.dequeueReusableCell(
                    withReuseIdentifier: Main.CellIdentifier
                        .HomeCategoryCollectionViewCell,
                    for: indexPath
    ...
    func collectionView(
        ...
        default:
            delegate?.HomeTableViewCell(
                self,
                didSelectProduct: products[indexPath.row]
            )
        }
    }
}
