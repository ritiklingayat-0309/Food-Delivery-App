...
class CashOnDeliveryTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var lbllocCashOnDelivery: UILabel!
    ...
    override func awakeFromNib() {
        ...
        btnSelect.setImage(
            UIImage(systemName: Main.ImageName.circle),
            for: .normal
        )
        btnSelect.setImage(
            UIImage(systemName: Main.ImageName.circlefill),
            for: .selected
        )
    ...
    func applyTheme() {
        ...
        stackView.backgroundColor = theme.cellBackgroundColor
        lbllocCashOnDelivery.textColor = theme.primaryFontColor
    }
