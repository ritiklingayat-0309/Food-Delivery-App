...
class AboutUsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        case .Notification:
            ...
            self.setLeftAlignedTitleWithBack(
                LocalizationManager.shared.localizedString(
                    forKey: Main.aboutUsModel.navNotification
                ),
                target: self,
                action: #selector(backButtonTapped)
            )
        ...
        case .Inbox:
            ...
            self.setLeftAlignedTitleWithBack(
                LocalizationManager.shared.localizedString(
                    forKey: Main.aboutUsModel.navInbox
                ),
                target: self,
                action: #selector(backButtonTapped)
            )
        ...
        case .About:
            ...
            self.setLeftAlignedTitleWithBack(
                LocalizationManager.shared.localizedString(
                    forKey: Main.aboutUsModel.navAbout
                ),
                target: self,
                action: #selector(backButtonTapped)
            )
        ...
        tblView.register(
            UINib(
                nibName: Main.CellIdentifier.AboutUsTableViewCell,
                bundle: nil
            ),
            forCellReuseIdentifier: Main.CellIdentifier.AboutUsTableViewCell
        )
