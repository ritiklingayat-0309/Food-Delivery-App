...
extension OffersViewController: UITableViewDelegate, UITableViewDataSource {
        ...
        -> UITableViewCell
    {
        ...
        let cell: OffersTableViewCell =
            tableView.dequeueReusableCell(
                withIdentifier: Main.CellIdentifier.OffersTableViewCell,
                for: indexPath
    ...
    @objc func applyTheme() {
        ...
        // MARK: - Buttons
        btnCheckOffer.backgroundColor = theme.mainColor
        btnCheckOffer.setTitleColor(theme.buttonTitle, for: .normal)
