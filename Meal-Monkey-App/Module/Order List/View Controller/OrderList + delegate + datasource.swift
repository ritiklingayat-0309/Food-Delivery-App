...
extension OrderListViewController: UITableViewDelegate, UITableViewDataSource {
        ...
        -> UITableViewCell
    {
        guard
            let cell = tableView.dequeueReusableCell(
                withIdentifier: Main.CellIdentifier.OrderListTableViewCell,
                for: indexPath
        ...
        guard let orderedItems = order.orderedItems as? Set<OrderedItem>,
        ...
        let orderedItemsArray = orderedItems.sorted {
    ...
    func tableView(
        ...
        if let detailVC = storyboard.instantiateViewController(
            withIdentifier: Main.ViewControllerIdentifier.MyOrderViewController
