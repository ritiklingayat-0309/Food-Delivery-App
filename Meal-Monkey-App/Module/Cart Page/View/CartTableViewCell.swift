...
class CartTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var lblLocalizeCategory: UILabel!

    @IBOutlet weak var lblLocalizePrice: UILabel!
    @IBOutlet weak var lblLocalizeType: UILabel!
    ...
    private func setLocalizedTexts() {
        lblLocalizeCategory.text = LocalizationManager.shared.localizedString(
            forKey: Main.Cart.category
        )
        lblLocalizePrice.text = LocalizationManager.shared.localizedString(
            forKey: Main.Cart.price
        )
        lblLocalizeType.text = LocalizationManager.shared.localizedString(
            forKey: Main.Cart.type
        )
    }
